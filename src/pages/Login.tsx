...
const Login: React.FC = () => {
  ...
  const handleForgotPassword = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!supabase) {
      setError('Password reset not available. Please check your configuration.');
      return;
    }
    ...
    try {
      ...
      setSuccess(`Password reset email sent to ${resetEmail}. Please check your inbox and follow the instructions to reset your password.`);
      setResetEmail('');
            ...
            <form onSubmit={handleForgotPassword} className="space-y-4">
              ...
              <div className="flex items-center justify-end space-x-3 pt-4">
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 disabled:opacity-50 disabled:cursor-not-allowed text-white px-6 py-2 rounded-xl transition-all duration-200 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                >
                  {resetLoading ? (
                    <div className="flex items-center justify-center space-x-2">
