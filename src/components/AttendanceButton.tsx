...
const AttendanceButton: React.FC<AttendanceButtonProps> = ({
  ...
  const getButtonClasses = () => {
    const baseClasses = "px-4 py-2 rounded-lg font-medium transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none";
